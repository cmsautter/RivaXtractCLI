...
internal sealed class JsonHeader
{
    ...
    [JsonPropertyName("file_table_size_u16")]
    public ushort FileTableSizeU16 { get; set; }

    [JsonPropertyName("file_table_offset_u32")]
    public uint FileTableOffsetU32 { get; set; }
    ...
    [JsonPropertyName("module_table_size_u16")]
    public ushort ModuleTableSizeU16 { get; set; }

    [JsonPropertyName("module_table_offset_u32")]
    public uint ModuleTableOffsetU32 { get; set; }

    [JsonPropertyName("module_count_u16")] public ushort ModuleCountU16 { get; set; }

    [JsonPropertyName("modmap_offset_u32")]
    public uint ModMapOffsetU32 { get; set; }
...
internal sealed class JsonEntry
{
    ...
    [JsonPropertyName("dos_datetime_local_iso")]
    public string? DosDateTimeLocalIso { get; set; }
